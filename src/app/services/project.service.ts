...
export class ProjectService {
  private apiUrl = 'http://localhost:8888/api/projects';
  ...
  getActiveProjects(): Observable<Project[]> {
    return this.http.get<Project[]>('http://localhost:8888/api/projects/active');
  }
  
  getArchivedProjects(): Observable<Project[]> {
    return this.http.get<Project[]>('http://localhost:8888/api/projects/archived');
  }
  
  archiveProject(id: number): Observable<void> {
    return this.http.put<void>(`http://localhost:8888/api/projects/${id}/archive`, {});
  }
